...
// a pre-built index keyed by case-folded title and alias. Keeping the
// index in memory is fine for personal-scale vaults (a few thousand
// pages at most).
...
// or aliases silently keep the first-inserted page; duplicate-alias
// detection is the lint package's job, not the resolver's.
...
// the link is broken. Matches titles first, then aliases. Case-insensitive.
